...
// VoxelBlockMesh class which stores a 3D array of VoxelBlocks
template <class TVoxelBlockType>
class VoxelBlockMesh {
...
public:
    ...
    VoxelBlockMesh(TPointType const& MinPoint, double ElementSize, int SizeX, int SizeY, int SizeZ)
